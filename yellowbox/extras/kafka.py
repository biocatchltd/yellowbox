...
from yellowbox.utils import get_free_port, RetryMixin

__all__ = ['KafkaService']


class KafkaService(RetryMixin, SingleEndpointService, RunMixin):
    ...
    def start(self):
        super().start()
        with self.retry(self.consumer, (KafkaError, ConnectionError, ValueError)):
            pass
        return self
